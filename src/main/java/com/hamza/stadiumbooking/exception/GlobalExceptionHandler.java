...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodNotSupported(Exception e) {
        return error("Method not allowed: " + e.getMessage(), HttpStatus.METHOD_NOT_ALLOWED);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Object> handleBadJson(HttpMessageNotReadableException e) { // narrowed type for clarity
